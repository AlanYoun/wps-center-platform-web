...
public class UrlUtils {
	...
	public static String getSampleDownloadUrl(String fileName, HttpServletRequest r) {
		System.out.println(UrlUtils.buildFullRequestDomain(r) + "/samples/" + fileName);
		return UrlUtils.buildFullRequestDomain(r) + "/samples/" + fileName;
	}
	
	public static String buildFullRequestDomain(HttpServletRequest r) {
